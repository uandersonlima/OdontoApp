    ...
    */
    ...
    function buildGotoAnchorHtml(component, gotoOptions, attrs, innerHtml) {
        ...
        if (!forceOff && component.opt('navLinks')) {
            ...
            return '<span class="text-muted"' + attrs + '>' +
                innerHtml +
                '</span>';
        }
    }
            ...
            if (buttonStr) {
                buttonStr.split(' ').forEach(function (buttonGroupStr, i) {
                    ...
                    buttonGroupStr.split(',').forEach(function (buttonName, j) {
                        ...
                        var buttonAriaAttr;
                        if (buttonName === 'title') {
                            groupChildren.push(htmlToElement('<h2 class="text-monospace font-weight-bold text-muted text-uppercase">&nbsp;</h2>')); // we always want it to take up height
                            isOnlyButtons = false;
                        }
                        else {
